...
powercfg /query SCHEME_CURRENT SUB_PROCESSOR | findstr /I "PERFAUTONOMOUS"
powercfg /query SCHEME_CURRENT SUB_PROCESSOR | findstr /I "PERFCHECK"
powercfg /query SCHEME_CURRENT SUB_PROCESSOR | findstr /I "PERFINCTIME"
powercfg /query SCHEME_CURRENT SUB_PROCESSOR | findstr /I "PERFDECTIME"
powercfg /query SCHEME_CURRENT SUB_PROCESSOR | findstr /I "CPMAXCORES"
